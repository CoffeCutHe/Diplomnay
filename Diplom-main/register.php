...
<body style="background-image:url(https://i.gifer.com/Bbmn.gif); background-repeat:no-repeat; background-size:cover;width:100%;">
     <div class="wrapper">
        <h2  style="color:white;">Регистрация</h2><br>
        <p  style="color:white;">Пожалуйста заполните поля.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
             ...
             <p  style="color:white;"> У тебя уже есть аккаунт? <a href="login.php">Авторизоваться</a>.</p>
         </form>
    </div>    
</body>
</html>
